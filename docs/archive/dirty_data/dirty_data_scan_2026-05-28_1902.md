# Dirty Data Scan Report — 2026-05-28_1902
...
| Probe | Count |
|---|---:|
| `A1.alpha_null_dataset_id_with_expr` | 5,037 |
| `A1b.alpha_null_dataset_id_with_task` | 0 |
| `A1c.alpha_null_dataset_id_no_task_brain_imported` | 5,037 |
| `A2.alpha_pre_brain_skip_recorded` | 0 |
| `A3.alpha_status_FAIL` | 0 |
| `A4.alpha_empty_metrics` | 2 |
...
### Samples — `A4.alpha_empty_metrics`

```
{"id": 11838, "task_id": 3101, "status": "created", "stage": "IS", "mt": "object", "created_at": "2026-05-19 04:28:38.694576"}
{"id": 11833, "task_id": 3094, "status": "created", "stage": "IS", "mt": "object", "created_at": "2026-05-19 04:28:15.025594"}
```
...
| `B4.iqc_audit_too_old_stale_false` | 1 |
...
### Samples — `B4.iqc_audit_too_old_stale_false`

```
{"id": 8003, "alpha_id": "zq5XGamo", "at": "2026-05-13T19:11:15.604705+00:00", "s": "false"}
```
...
| Probe | Count |
|---|---:|
| `C1.mining_task_running_stale_30m` | 1 |
| `C2.mining_task_running_no_persist_2h` | 0 |
| `C3.experiment_run_running_stale_1h` | 26 |
...
### Samples — `C1.mining_task_running_stale_30m`

```
{"id": 3701, "task_name": "flat-session-USA-20260526-001724", "status": "PAUSED", "schedule": "FLAT", "updated_at": "2026-05-26 01:29:07.700827+00:00", "last_alpha_persisted_at": "2026-05-26 01:29:02.604269+00:00"}
```

### Samples — `C3.experiment_run_running_stale_1h`

```
{"id": 1193, "task_id": 3731, "status": "RUNNING", "trigger_source": "WATCHDOG_REVIVE", "started_at": "2026-05-26 15:33:34.785398", "finished_at": null}
{"id": 1190, "task_id": 3729, "status": "RUNNING", "trigger_source": "API", "started_at": "2026-05-26 15:13:46.506481", "finished_at": null}
{"id": 1137, "task_id": 3403, "status": "RUNNING", "trigger_source": "API", "started_at": "2026-05-22 16:35:12.075909", "finished_at": null}
{"id": 1136, "task_id": 3402, "status": "RUNNING", "trigger_source": "API", "started_at": "2026-05-22 14:56:32.019621", "finished_at": null}
{"id": 1127, "task_id": 3373, "status": "RUNNING", "trigger_source": "API", "started_at": "2026-05-21 17:00:13.826460", "finished_at": null}
{"id": 1116, "task_id": 3329, "status": "RUNNING", "trigger_source": "WATCHDOG_REVIVE", "started_at": "2026-05-21 03:44:14.845503", "finished_at": null}
{"id": 1115, "task_id": 3329, "status": "RUNNING", "trigger_source": "WATCHDOG_REVIVE", "started_at": "2026-05-21 03:14:14.835316", "finished_at": null}
{"id": 1114, "task_id": 3329, "status": "RUNNING", "trigger_source": "WATCHDOG_REVIVE", "started_at": "2026-05-21 02:44:14.829757", "finished_at": null}
{"id": 1113, "task_id": 3329, "status": "RUNNING", "trigger_source": "WATCHDOG_REVIVE", "started_at": "2026-05-21 02:14:14.817662", "finished_at": null}
{"id": 1112, "task_id": 3329, "status": "RUNNING", "trigger_source": "WATCHDOG_REVIVE", "started_at": "2026-05-20 22:41:23.461963", "finished_at": null}
```
...
| `D3.hypothesis_active_but_abandoned` | 290 |
| `D4.alpha_failure_unanalyzed_old` | 1,310 |
...
### Samples — `D3.hypothesis_active_but_abandoned`

```
{"id": 682, "status": "SUPERSEDED", "is_active": true, "abandon_reason": "V-19.7 zombie cleanup — pre-fix non-primary siblings never received alphas; transitioned ACTIVE → SUPERSEDED to clear list_active sampling pool.", "created_at": "2026-05-06 06:55:33.485121+00:00"}
{"id": 681, "status": "SUPERSEDED", "is_active": true, "abandon_reason": "V-19.7 zombie cleanup — pre-fix non-primary siblings never received alphas; transitioned ACTIVE → SUPERSEDED to clear list_active sampling pool.", "created_at": "2026-05-06 06:55:33.485121+00:00"}
{"id": 680, "status": "SUPERSEDED", "is_active": true, "abandon_reason": "V-19.7 zombie cleanup — pre-fix non-primary siblings never received alphas; transitioned ACTIVE → SUPERSEDED to clear list_active sampling pool.", "created_at": "2026-05-06 06:55:33.485121+00:00"}
{"id": 679, "status": "SUPERSEDED", "is_active": true, "abandon_reason": "V-19.7 zombie cleanup — pre-fix non-primary siblings never received alphas; transitioned ACTIVE → SUPERSEDED to clear list_active sampling pool.", "created_at": "2026-05-06 06:55:33.485121+00:00"}
{"id": 674, "status": "SUPERSEDED", "is_active": true, "abandon_reason": "V-19.7 zombie cleanup — pre-fix non-primary siblings never received alphas; transitioned ACTIVE → SUPERSEDED to clear list_active sampling pool.", "created_at": "2026-05-06 06:39:11.358342+00:00"}
```
...
## Grand total flagged rows: 19,658