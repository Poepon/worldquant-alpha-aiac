...
| 项 | 判定 | 一句理由 |
|---|---|---|
| 多挖**熟字段**(再挖 ~886 已用字段)/ orchestrator 翻 flag / Phase2 bandit / 多账号 | NO-GO 冻结 | 供给 >> 选择能力;regime 下再挖熟字段 = 0 yield 纯烧。**注意:挖未碰的 89% 正交字段 ≠ 此 NO-GO**(见 §1.6 + 广度环,那是 DEFER 非 NO-GO)|
